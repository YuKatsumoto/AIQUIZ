...
{
    // Accept full asset paths ("/Game/AiQuiz/Pawn/BP_AiQuizPawn") as well as
    // bare names, which resolve to the legacy /Game/Blueprints/ folder.
    FString AssetPath = BlueprintName.StartsWith(TEXT("/"))
        ? BlueprintName
