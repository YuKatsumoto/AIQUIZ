...
const STATE_ATHLETIC_RACE = "ATHLETIC_RACE"

const RACE_PHASE_BIKE = "BIKE"
const RACE_PHASE_OBSTACLE_RUN = "OBSTACLE_RUN"
const RACE_PHASE_SWIM = "SWIM"
const RACE_PHASE_FINAL_SPRINT = "FINAL_SPRINT"
